...
class TestLLMIntegration(unittest.TestCase):
    ...
    def test_normalize_actor_id_for_unit_and_player_actions(self):
        """Ensure that agent actor_id is mapped correctly to unit_id or player_id"""
        handler = self.create_mock_handler()
        ...
        normalized = handler._normalize_agent_action(unit_action)
        ...
        normalized2 = handler._normalize_agent_action(player_action)
        ...
        normalized3 = handler._normalize_agent_action(city_action)
        ...
        normalized4 = handler._normalize_agent_action(explicit_unit_action)
