...
class AgentWebSocketHandler:
    ...
    def _transform_to_proxy_format(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if msg_type == "llm_connect":
            # Proxy expects: type, agent_id, api_token, port (optional), nation (optional), leader_name (optional), game_id (optional), auto_ready (optional, defaults to True), game_config (optional)
            allowed_fields = {"type", "agent_id", "api_token", "port", "nation", "leader_name", "game_id", "auto_ready", "game_config"}
